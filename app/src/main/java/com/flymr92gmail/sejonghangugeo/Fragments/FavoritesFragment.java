...
public class FavoritesFragment extends DialogFragment{
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String string = "<p>&emsp;Так говорят о человеке, который возвысившись, возомнил себя пупом земли. Русский аналог – «Из грязи – в князи».</p>\n" +
        ...
        dialog = (builder.setTitle("Благодарности").setView(form).setPositiveButton(R.string.cancel, new DialogInterface.OnClickListener() {
            @Override
